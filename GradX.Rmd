...
# Train logistic regression model on selected features of the training data
model <- glm(Target ~ Age.at.enrollment + Scholarship.holder + `Gender` + `Curricular.units.1st.sem..grade.` + `Curricular.units.2nd.sem..grade.` , 
